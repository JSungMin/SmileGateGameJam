...
namespace AStar_2D
{
    ...
    {
        // Private
        private PathSession session = null;
        ...
        /// <summary>
        /// <see cref="DynamicObstacle"/> implementation. 
        /// </summary>
        ...
        private void moveTowards()
        {
            ...
            Vector3 update = Vector3.MoveTowards(lastPosition, session.WorldPosition, moveSpeed * Time.deltaTime);
